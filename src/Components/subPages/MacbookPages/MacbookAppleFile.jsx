...
const MacbookAppleFile= () => {
  const [data,setData]=useState([]);

  useEffect(()=>{
    axios.get('https://techdips-com.onrender.com/products/fetchbycat/macbook')
    .then((res)=>{
  ...
  return (
   ...
   <div className='alldata'>
    {data.filter((val)=>{
        return val.subcat==="applemacbook"
    }).map((post)=>{
...
export default MacbookAppleFile;
